...
// Return a pointer to the graph
std::unique_ptr<Digraph> readGraph(const std::string& fileName) {
    std::ifstream file{"/Users/viktorsvensson/Desktop/MT/År 3/Termin 2/TND004 - Datastrukturer/Labbar/lab4/code/code4a/" + fileName};  // modify the file path, if needed (Mac)
